    ...
    <div class="success-container">
      <div class="success-content">
        ...
        <div class="success-message">
          <p>Vielen Dank für Ihren Einkauf. Sie erhalten in Kürze eine E-Mail mit Ihrer Bestellbestätigung und weiteren Informationen.</p>
        </div>

        <div class="actions">
          <a mat-raised-button color="accent" routerLink="/shop">
            Zurück zum Shop
          </a>
        </div>
      </div>
